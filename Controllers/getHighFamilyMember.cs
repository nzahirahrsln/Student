...
namespace HighFamilyMemberData
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string query = "SELECT TOP 1 [Given Name] + ' (' + CAST([No of Member] AS VARCHAR) + ')' AS HighestFamilyMember " +
                                "FROM Table1 INNER JOIN Table3 ON Table1.Col_1 = Table3.Col_1 ORDER BY[No of Member] DESC";
